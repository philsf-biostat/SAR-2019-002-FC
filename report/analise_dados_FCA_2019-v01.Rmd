...
Embora a ASC não estivesse homogeneamente distribuída entre as categorias do instrumento (Levene p=`r dlqi.asc.levene.p`), foi possível detectar uma diferença significativa entre os participantes que
não sofreram efeito na qualidade de vida
e os que possuíram
efeito Grave
(pós-teste p=`r dlqi.asc.pw$p.value[3, 1]`, corrigido p/ Bonferroni).
