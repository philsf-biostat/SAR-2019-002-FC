...
Embora a ASC não estivesse homogeneamente distribuída entre as categorias do instrumento (Levene p=`r dlqi.asc.levene.p`), foi possível detectar um aumento significativo (pós-teste p=`r dlqi.asc.pw$p.value[3, 1]`, corrigido p/ Bonferroni) entre os escores declarados pelos participantes que
...
Quanto à atividade laboral, os laboralmente ativos declararam escore mediano (IQR) 22.00 [10.50, 54.50] enquanto os inativos apresentaram escore mediano 34.00 [20.75, 56.75].
