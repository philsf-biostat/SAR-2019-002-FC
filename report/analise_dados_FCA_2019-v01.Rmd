...
Variáveis quantitativas foram descritas como média (DP), e variáveis qualitativas foram descritas usando frequência e proporção (%).
Os escores dos instrumentos do tipo Likert ou semi-Likert foram descritos usando mediana e intervalo interquartil.
